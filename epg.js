...
function renderFullEPGList() {
  ...
  // orfanava anche le immagini non ancora caricate della lista canali (che
  // usa lo stesso observer). Ora si sganciano solo le immagini di QUESTO
  // container, lasciando intatte quelle delle altre liste.
  unobserveContainerImages(list);
