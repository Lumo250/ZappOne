...
function renderFullEPGList() {
 ...
 // se non ci sono dati EPG
  ...
  epgDisplayList
    ...
    // logo — caricamento DIRETTO (niente lazy loading): l'IntersectionObserver
    // non scatta in modo affidabile su iOS 15 quando il container ha
    // overflow: hidden sul parent e overflow-y: auto sul figlio. Il Full EPG
    // ha un numero contenuto di elementi, il caricamento diretto è accettabile.
    const logo = document.createElement('img');
    logo.className = 'channel-logo';
 logo.loading = 'lazy';
    logo.src = epgChannel.logo || 'img/placeholder.png';
