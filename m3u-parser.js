    ...
    return new Promise((resolve, reject) => {
        ...
        const workerCode = `
            const REGEX = {
                ...
                EXTGRP: /^#EXTGRP:/,
                EXTVLCOPT: /^#EXTVLCOPT:/,
                // FIX: cattura dall'ULTIMA virgola della riga, non dalla prima.
                // Con /,(.*)$/ una virgola dentro un attributo precedente (es. tvg-logo="...,...")
                // troncava/corrompeva il nome canale. Il '.*' iniziale è greedy e "backtracka"
                // fino all'ultima virgola disponibile, che è il vero separatore del titolo.
                NAME: /.*,(.*)$/,
