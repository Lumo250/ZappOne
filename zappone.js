...
// ============================================================
// processSwipe con navigazione tra viste (solo navigazione, nessun cambio lista/griglia)
// ============================================================
function processSwipe(dx, dy) {
  ...
  if (isEPGView) {
    ...
    if (dx < 0) {
      ...
      window.isEPGView = false;  // Non siamo più nell'EPG manager
      window.isPlaylistView = false;
    }
    return;
  }
  ...
  // Se siamo in canali e swipe a sinistra: non facciamo nulla
  // (il cambio lista/griglia è gestito solo dal pulsante)
  // (dx < 0) -> non facciamo nulla
}
