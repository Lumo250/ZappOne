...
function renderFullEPGList() {
  ...
  // (Ripristinato il pattern originale, già usato in renderGroupedChannelList:
  // la funzione "unobserveContainerImages" introdotta in precedenza non era
  // definita da nessuna parte e causava un ReferenceError bloccante alla prima
  // apertura del Full EPG con dati presenti.)
